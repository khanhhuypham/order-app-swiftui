...
struct SettingVIew: View {
    ...
    var body: some View {
        let GPBH = String(format: "Version: %@ (GPBH%d-OPTION-0%d)","0",Constants.setting.branch_type ?? 0,Constants.setting.branch_type_option ?? 0)
            ...
            Form{
                Group{
                    HStack{
                        ...
                        Image(uiImage: UIImage(systemName: "doc.badge.clock.fill")!)
                            .resizable()
                            .frame(width: 100, height: 100,alignment: .center)
                                                          
                            
                            Text("Wolf Knight").font(fonts.title)
                            
                            Text("WolfKnight@kingdom.tv").font(.subheadline).foregroundColor(.gray)
