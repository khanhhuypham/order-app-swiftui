...
public struct APIEndPoint {
    ...
    struct Name {
        ...
        static let urlGetTotalAmountOfOrders = "api/\(version)/orders/total-amount" // api lấy tổng giá trị của tất cả đơn hàng của quán
        ...
        static let urlPostApplyOnlyCashAmount = "/api/\(version)/branches/%d/setting/is-apply-only-cash-amount" // api cập nhật service
        static let urlGetApplyOnlyCashAmount = "/api/\(version)/branches/%d/setting/is-apply-only-cash-amount" // api cập nhật service
        ...
        static let urlgetBrandSetting = "/api/\(version)/restaurant-brands/%d/setting"
