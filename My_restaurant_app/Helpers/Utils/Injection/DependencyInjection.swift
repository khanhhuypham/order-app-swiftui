...
public struct InjectedValues{
    ...
    var order: DAIHYORDER {
        get {
            guard let injected = Self[DAIHYProviderKey.self] else {
                fatalError("Chat client was not setup")
            }
            return injected
        }
        set {
            Self[DAIHYProviderKey.self] = newValue
        }
    }
    ...
    var colors: ColorPalette {
        get {
            order.appearance.colors
        }
        set {
            order.appearance.colors = newValue
        }
    }
    ...
    var fonts: Fonts {
        get {
            order.appearance.fonts
        }
        set {
            order.appearance.fonts = newValue
        }
    }
