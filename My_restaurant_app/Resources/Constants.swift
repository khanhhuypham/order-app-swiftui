...
struct Constants {
    ...
    static var branch:Branch{
        get{
            ManageCacheObject.getBranch() ?? Branch()
        }
    }
        
    static var brand:Brand{
        get{
            ManageCacheObject.getBrand() ?? Brand()
        }
    }
    ...
    static var restaurant_id:Int{
        get{
            return ManageCacheObject.getBrand()?.restaurant_id ?? 0
        }
    }
...
//    
    ...
    static var setting:AccountSetting{
        get{
            return ManageCacheObject.getAccountSetting() ?? AccountSetting()
        }
    }
...
class PRINTER_NOTIFI : NSObject {
    ...
    @objc static let IS_PRINT_WIFI = "vn.techres.is_print_wifi"
